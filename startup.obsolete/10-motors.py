...
def define_motors(): 
    ...
    #return microscope,sbs,saxs,waxs1,waxs2,sg2,dda,ssa,wbm,mono,hfm,vfm,bpm_pos,bpm2_pos
    
    return microscope,sbs,saxs,waxs1,waxs2,sg2,dda,ssa,wbm,hfm,vfm,bpm_pos,bpm2_pos
...
def ready_for_robot(motors, positions, init=False):
    ...
    def cb(*args, obj, sub_type, **kwargs):
        ...
        print(f"callback triggered by {obj.name}, {sub_type}")
        if sub_type!='start_moving':
            return

        print('clearing motor motion watch ...')
...
microscope,sbs,saxs,waxs1,waxs2,sg2,dda,ssa,wbm,hfm,vfm,bpm_pos,bpm2_pos = define_motors()

#microscope,sbs,saxs,waxs1,waxs2,sg2,dda,ssa,wbm,mono,hfm,vfm,bpm_pos,bpm2_pos = define_motors()
