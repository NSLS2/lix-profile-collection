...
em1.read_attrs = ['sum_all']
em1.sum_all.mean_value.kind = 'hinted'

# this is used when em1 is used in fly scans
em1ext = LiXTetrAMMext('XF:16IDC-BI{BPM:1}', name='em1')
em1ext.read_attrs = ['sum_all']
em1ext.sum_all.mean_value.kind = 'hinted'
...
em2ext = LiXTetrAMMext('XF:16IDC-BI{BPM:2}', name='em2')
