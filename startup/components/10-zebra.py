...
# Pilatus triggering
zebra.pulse1.input_addr.put(ZA.IN3_OC)       # from Newport XPS controller
zebra.pulse1.width.put(0.04)                 # this needs to be adjusted for Xspress3, see 20-xspress3.py
zebra.pulse1.delay.put(0)
zebra.pulse1.time_units.put('s')
