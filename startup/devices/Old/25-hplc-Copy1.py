...
'''
TCP_IP = '10.66.122.159'  ##moxa on HPLC cart.  Port 1 is Buffer Selector Valve, Port 2 is regen pump, Port 3 10-port column selection valve, Port 4 pump purge, port 5 col1purge , port6 regen_pump2
Pump_TCP_PORT = 4002
Col_Sel_PORT = 4003
...
###Commands for 10-port (Col_Sel) valve.  Setup as regeneration pump and used for co-flow (in-progress).
'''
'''
class VICI_valves:
    def __init__(self):
